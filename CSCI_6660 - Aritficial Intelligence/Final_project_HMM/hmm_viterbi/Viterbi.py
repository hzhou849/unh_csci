...
class Viterbi:
    ...
    def start(self):
        ...
        for tIndex, tStep in enumerate(self.timeStep):
            print("\n\n===============  TIME STEP v({})_E({} ) ===========".format(tIndex, self.evidenceObserved[tIndex]))
            ...
            if tIndex == 0:
                ...
                for cellNum in self.statesList:
                    ...
                    maxPathCell = 0
                    print("\n--- State({}); ngbrList: {} ---".format(cellNum, ngbrList))
                    for index, ngbrCell in enumerate(ngbrList):
                        ...
                        print("(et|xt)):{} * (x_t+1 |xt):{} * maxPrevS({}):{:0.8f}".format(evidProb, transProb,ngbrCell, prevTstepNgbrVitVal))
                        print("t{}; ngbrCell:{}; vVal: {:0.8f}".format(tIndex, ngbrCell, vVal))
        ...
        print ("\n====== Final backtrace prediction:=====")
        maxState = self.timeStep[lastTimeStep].findMaxState()
        print("\nMaxState at final step found: {}".format(maxState))

        print("\nBacktrace results: [END]-->{}".format(maxState), end="")
        prevVal = 0
