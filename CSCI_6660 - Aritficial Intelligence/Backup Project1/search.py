...
def breadthFirstSearch(problem):
	...
	while qList.isEmpty() == False:
		# test = problem.getExpandedStates()
		# print(test, end=', ')
		currPath = qList.pop()
...
def uniformCostSearch(problem):
	...
	while pQueue.isEmpty() == False:
		...
		# for sublist in fringe:
		# 	print ("sublist: {}".format(sublist[attrXY]))
...
def aStarSearch(problem, heuristic=nullHeuristic):
	...
	# for p in  problem.getSuccessors(start):
	# 	print("Heuristic value: {}: {}".format(p[ATTR_XY], heuristic(p[ATTR_XY], problem)))
	# 	print ("testing lambda: {}".format(calcHn(p)))
