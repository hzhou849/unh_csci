/*
To answer the Zion Bookstore question, the result table must contain columns from the previously
identified tables or columns that can be computed from the tables. The result table should 
contain the following: Customer state (Customer.State), Book ID (Sale.BookID), 
book title (Book.Title), number of books purchased (Sale.Quantity), and total price (Sale.Quantity × Sale.UnitPrice).
/*
