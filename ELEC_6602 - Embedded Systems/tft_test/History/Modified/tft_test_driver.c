...
TButton Button1;
TEvent  Button1_OnUp;
TEvent  Button1_OnDown;
TEvent  Button1_OnClick;
TEvent  Button1_OnPress;
...
static void InitObjects() {
  ...
  Box1.Active        = 1;
  Box1.OnUp          = &Box1_OnUp;
  Box1.OnDown        = &Box1_OnDown;
  Box1.OnClick       = &Box1_OnClick;
  Box1.OnPress       = &Box1_OnPress;

  Box1_OnUp.Action       = (void *)0;
  Box1_OnUp.Sound.SndAct = VTFT_SNDACT_NONE;
  Box1_OnUp.Sound.Effect = 0;
  Box1_OnUp.Sound.Pitch  = 0;
  Box1_OnUp.Sound.Volume = 0;

  Box1_OnDown.Action       = (void *)0;
  Box1_OnDown.Sound.SndAct = VTFT_SNDACT_NONE;
  Box1_OnDown.Sound.Effect = 0;
  Box1_OnDown.Sound.Pitch  = 0;
  Box1_OnDown.Sound.Volume = 0;

  Box1_OnClick.Action       = (void *)0;
  Box1_OnClick.Sound.SndAct = VTFT_SNDACT_NONE;
  Box1_OnClick.Sound.Effect = 0;
  Box1_OnClick.Sound.Pitch  = 0;
  Box1_OnClick.Sound.Volume = 0;

  Box1_OnPress.Action       = (void *)0;
  Box1_OnPress.Sound.SndAct = VTFT_SNDACT_NONE;
  Box1_OnPress.Sound.Effect = 0;
  Box1_OnPress.Sound.Pitch  = 0;
  Box1_OnPress.Sound.Volume = 0;
  ...
  Button1.Source        = -1UL;
  Button1.Active        = 1;
  Button1.OnUp          = &Button1_OnUp;
  Button1.OnDown        = &Button1_OnDown;
  Button1.OnClick       = &Button1_OnClick;
  Button1.OnPress       = &Button1_OnPress;

  Button1_OnUp.Action       = (void *)0;
  Button1_OnUp.Sound.SndAct = VTFT_SNDACT_NONE;
  Button1_OnUp.Sound.Effect = 0;
  Button1_OnUp.Sound.Pitch  = 0;
  Button1_OnUp.Sound.Volume = 0;

  Button1_OnDown.Action       = (void *)0;
  Button1_OnDown.Sound.SndAct = VTFT_SNDACT_NONE;
  Button1_OnDown.Sound.Effect = 0;
  Button1_OnDown.Sound.Pitch  = 0;
  Button1_OnDown.Sound.Volume = 0;

  Button1_OnClick.Action       = (void *)0;
  Button1_OnClick.Sound.SndAct = VTFT_SNDACT_NONE;
  Button1_OnClick.Sound.Effect = 0;
  Button1_OnClick.Sound.Pitch  = 0;
  Button1_OnClick.Sound.Volume = 0;

  Button1_OnPress.Action       = (void *)0;
  Button1_OnPress.Sound.SndAct = VTFT_SNDACT_NONE;
  Button1_OnPress.Sound.Effect = 0;
  Button1_OnPress.Sound.Pitch  = 0;
  Button1_OnPress.Sound.Volume = 0;
